...
function generateColor(): ColorRGB {
  const hue = Math.random() * (275 - 255) + 255; // Hue between 255-275 for deep violet
  const saturation = Math.random() * (0.7 - 0.5) + 0.5; // Higher saturation (0.5 to 0.7) for richness
  const value = Math.random() * (0.4 - 0.2) + 0.2; // Lower brightness (0.2 to 0.4) for deep effect
